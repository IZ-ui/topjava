...
public class MealsUtil {
    ...
    public static final List<Meal> meals2 = Arrays.asList(
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 10, 0), "Завтрак(user2)", 666),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 13, 0), "Обед(user2)", 1111),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 20, 0), "Ужин(user2)", 555),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 10, 0), "Завтрак(user2)", 1111),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 13, 0), "Обед(user2)", 555),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 20, 0), "Ужин(user2)", 444)
    );
